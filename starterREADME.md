```md
HEADER
Header contains Name, Navigation, and Titles as well as navbar
...
CONTACT
Contact section contains a contact form with fields for users namne, email address, and a short message.
